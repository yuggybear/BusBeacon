...
export default function ParentStudentManager({ user, onLinksChanged }) {
  ...
  return (
    <div className="bg-white dark:bg-slate-950 rounded-xl border p-6">
      ...
      <div className="space-y-2 mb-4">
        ...
        {links.map((link) => {
          ...
          return (
            <div
              key={link.id}
              className="flex items-center gap-3 p-3 rounded-lg bg-slate-50 dark:bg-slate-900 border"
            >
      ...
      {showAdd && (
        <div className="space-y-3 p-4 rounded-lg border bg-slate-50 dark:bg-slate-900">
          {!bus ? (
            ...
            <div className="space-y-3">
              <div className="p-2 rounded-lg bg-green-50 dark:bg-green-950/50 border border-green-200 dark:border-green-800 text-center">
