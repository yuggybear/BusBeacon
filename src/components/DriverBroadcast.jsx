  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 gap-2 mb-3">
        {PRESETS.map((preset) => (
          <button
            ...
            disabled={sending}
            className="h-12 rounded-xl bg-blue-50 dark:bg-blue-950/50 border border-blue-200 dark:border-blue-800 text-sm font-medium text-blue-700 dark:text-blue-300 hover:bg-blue-100 dark:hover:bg-blue-900 active:scale-95 transition-all"
          >
            {preset.label}
          </button>
        ))}
      ...
      <div className="space-y-2">
        {transcript && (
          <div className="p-3 rounded-lg bg-slate-50 dark:bg-slate-900 border text-sm">{transcript}</div>
        )}
