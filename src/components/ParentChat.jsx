...
export default function ParentChat({ busId, user }) {
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="px-4 py-2 border-b bg-white dark:bg-slate-950 shrink-0">
              ...
              >
                <div
                  className={`max-w-[80%] rounded-2xl px-3 py-2 ${
                    isMine ? "bg-blue-600 text-white" : "bg-white dark:bg-slate-950 border"
                  }`}
                >
                  {!isMine && (
      ...
      <form onSubmit={handleSend} className="flex gap-2 p-3 border-t bg-white dark:bg-slate-950 shrink-0">
        <Input
