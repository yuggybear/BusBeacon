...
export default function DriverCodeEntry() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900 flex items-center justify-center p-6 safe-area-top safe-area-bottom">
          ...
          <div className="flex gap-1 p-1 bg-slate-100 dark:bg-slate-800 rounded-lg mb-6">
            <button
              ...
              className={`flex-1 h-11 rounded-md text-sm font-medium transition-colors touch-none flex items-center justify-center ${
                mode === "code" ? "bg-white dark:bg-slate-950 shadow text-slate-900 dark:text-slate-100" : "text-muted-foreground"
              }`}
            >
            ...
            <button
              ...
              className={`flex-1 h-11 rounded-md text-sm font-medium transition-colors touch-none flex items-center justify-center ${
                mode === "select" ? "bg-white dark:bg-slate-950 shadow text-slate-900 dark:text-slate-100" : "text-muted-foreground"
              }`}
            >
          ...
          {mode === "code" ? (
            <>
              ...
              <form onSubmit={handleCodeSubmit} className="space-y-4">
                ...
                />
                {error && (
                  <div className="flex items-center gap-2 text-sm text-red-600 bg-red-50 dark:bg-red-950/50 rounded-lg p-3">
            ...
            <>
              ...
              {error && (
                <div className="flex items-center gap-2 text-sm text-red-600 bg-red-50 dark:bg-red-950/50 rounded-lg p-3 mt-4">
                  <AlertCircle className="w-4 h-4 shrink-0" />
                  {error}
                </div>
              )}
