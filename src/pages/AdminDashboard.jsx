  ...
  return (
    <div className="flex flex-col h-[calc(100vh-64px)] lg:h-screen">
      ...
      <div className="flex flex-col lg:flex-row flex-1 min-h-0 overflow-y-auto lg:overflow-hidden">
        {/* Left panel */}
        <div className="lg:w-[400px] lg:border-r border-b lg:border-b-0 lg:overflow-y-auto bg-white dark:bg-slate-950 shrink-0">
          {user.is_main_admin && (
          ...
          <div className="p-4">
            ...
            {showAddBus && (
              <div className="space-y-2 mb-3 p-3 rounded-lg bg-slate-50 dark:bg-slate-900 border">
                <Input
                  ...
                  <button
                    ...
                    className={`w-full flex items-center gap-3 p-3 rounded-xl border text-left transition-colors ${
                      selectedBusId === bus.id
                        ...
                        : "bg-white dark:bg-slate-950 hover:bg-slate-50 dark:hover:bg-slate-800 border-slate-200 dark:border-slate-800"
                    }`}
                  >
            ...
            <div className="p-4 border-t">
              ...
              <div className="space-y-1.5 mb-3">
                {stops.map((stop) => (
                  <div
                    key={stop.id}
                    className="flex items-center gap-2 p-2 rounded-lg bg-slate-50 dark:bg-slate-900 text-sm"
                  >
              ...
              <div className="space-y-2 p-3 rounded-lg border bg-slate-50 dark:bg-slate-900">
                <Input
        ...
        <div className="flex-1 min-h-[300px] lg:min-h-0 flex flex-col">
          <div className="flex items-center gap-1 p-2 border-b bg-white dark:bg-slate-950 shrink-0">
            <button
...
function SchoolSetup({ user, onSaved }) {
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] lg:min-h-screen bg-gradient-to-b from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900 flex items-center justify-center p-6">
...
function PendingVerification({ user, onVerified }) {
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] lg:min-h-screen bg-gradient-to-b from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900 flex items-center justify-center p-6">
      <div className="max-w-md w-full">
        <div className="bg-white dark:bg-slate-950 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-800 p-8 text-center">
