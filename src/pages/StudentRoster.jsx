...
import { Users, Plus, Trash2, Pencil, X, Check, RefreshCw } from "lucide-react";
...
export default function StudentRoster() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-64px)] lg:h-screen">
      ...
      />
      <div ref={scrollRef} className="flex-1 overflow-y-auto bg-slate-50 dark:bg-slate-900 pb-6 lg:pb-0">
        ...
        <div className="max-w-5xl mx-auto p-4 lg:p-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-4">
            ...
            <div className="flex gap-2">
              <span className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-white dark:bg-slate-950 border text-xs font-medium">
          ...
          {/* Add student form */}
          {showAdd && (
            <div className="bg-white dark:bg-slate-950 rounded-xl border p-4 mb-4">
          ...
          {/* Student table */}
          {buses.length === 0 ? (
            <div className="bg-white dark:bg-slate-950 rounded-xl border p-8 text-center">
              <p className="text-sm text-muted-foreground">
            ...
            <>
              ...
              <div className="block md:hidden space-y-2">
                {students.map((student) => {
                  ...
                  return (
                    <div key={student.id} className="bg-white dark:bg-slate-950 rounded-xl border p-4">
                      ...
                      {isEditing ? (
                        <div className="flex items-center gap-2 mt-2">
                          ...
                          <button
                            ...
                            className="h-11 w-11 flex items-center justify-center rounded-lg text-green-600 hover:bg-green-50 touch-none shrink-0"
                          >
                            <Check className="w-4 h-4" />
                          </button>
                          <button
                            onClick={() => setEditingId(null)}
                            className="h-11 w-11 flex items-center justify-center rounded-lg text-muted-foreground hover:bg-slate-100 touch-none shrink-0"
                          >
                            <X className="w-4 h-4" />
                          </button>
                        </div>
              ...
              {/* Desktop: table */}
              <div className="hidden md:block bg-white dark:bg-slate-950 rounded-xl border overflow-hidden">
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b bg-slate-50 dark:bg-slate-900 text-left text-xs text-muted-foreground">
                  ...
                  <tbody>
                    {students.map((student) => {
                      ...
                      const isEditing = editingId === student.id;
                      return (
                        <tr key={student.id} className="border-b last:border-0 hover:bg-slate-50 dark:hover:bg-slate-800">
